...
public class AccountsController {
    ...
    public ResponseEntity<String> getBuildVersionFallback(Throwable throwable) {
        ...
        return ResponseEntity
                .status(HttpStatus.OK)
                .body("0.9"); // Any logic can be written inside this method, that will be executed after the retries in the original method
    }
    ...
    @Operation(
            ...
            description = "Contact details that can be reached out in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
